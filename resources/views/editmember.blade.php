...
<form action="/member/update/{{ $profile->id }}" method="post" enctype="multipart/form-data">
    @csrf
        <div class="avatar-upload">
            ...
            <div class="avatar-preview">
                ...
                @else
                <div id="imagePreview" style="background-image: url('{{ asset('storage/'.$profile->foto) }}');" alt="{{ $profile->foto }}"></div>
                @endif  
            </div>
        </div>
    <div class="row row-cols-2 g-2 mt-1" style="font-size: 13px">
        <div class="col-6 col-md-6">
            ...
            <input type="text" name="username" class="form-control" id="firstname" value="{{ $profile->user->username}}">
        </div>
        <div class="col-6 col-md-6">
